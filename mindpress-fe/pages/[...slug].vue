    ...
    <main class="container">
      <ContentDoc v-slot="{ doc }">
        ...
        <div class="article-meta">
          ...
          <span class="article-meta">{{ formatDate(doc.time, 'en') }} </span>
          <span class="article-meta" style="margin-left:0.3rem">{{ mpFormatAuthor(doc) }}</span>
          <NuxtLink :to="'/edit?id=' + doc._id">
